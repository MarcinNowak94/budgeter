...
aplikacja DB Browser for SQLite \cite{DBBrowser}. Aplikacja Visual Studio Code 
...
\section{\customstylesection{Graficzny interfejs użytkownika}} \label{Graficzny interfejs użytkownika}
